<template>
  <div class="mobile-footer">
    ...
    <span class="blog"><nuxt-link to="/blog"><i class="fa fa-book"></i></nuxt-link></span>
...
<script>
  export default {
    data() {
      return {
        homeAbout: '/about',
        homeAboutIcon: 'fa fa-user-circle'
      }
    },
    ...
    watch: {
      '$route': function(e) {
        if(e.path == '/') {
          this.homeAbout = '/about'
          this.homeAboutIcon = 'fa fa-user-circle'
        } else {
          this.homeAbout = '/'
          this.homeAboutIcon = 'fa fa-home'
        }
      }
    }
  }
...
<style scoped>
  ...
  .mobile-footer{
    ...
    grid-template: 45px / repeat(4, 1fr);
    text-align: center;
    position: fixed;
    bottom: 0;
    left: 0;
